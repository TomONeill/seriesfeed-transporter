...
module SeriesfeedTransporter.Controllers {
    export class ExportController {
        ...
        private addFavourites(cardContent: JQuery<HTMLElement>): void {
            const favourites = new ViewModels.Button(Enums.ButtonType.Success, "fa-star-o", "Favorieten", () => Services.RouterService.navigate(Enums.ShortUrl.ExportFavourites), "100%");
